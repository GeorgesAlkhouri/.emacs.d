...
**** applications
#+begin_src emacs-lisp
(general-create-definer global-menu-applications :states '(normal visual) :prefix "SPC a" "" '(:ignore t :which-key "applications"))
#+end_src

**** search
#+begin_src emacs-lisp
(general-create-definer global-menu-search :states '(normal visual) :prefix "SPC s" "" '(:ignore t :which-key "search"))
#+end_src
...
#+begin_src emacs-lisp
    ...
    (global-menu-file "e" '(:ignore t :which-key "env") 
     "ed" '((lambda () (interactive) (find-file (expand-file-name "init.org" user-emacs-directory))) :which-key "init.org config")
     "ef" '(straight-freeze-versions :which-key "freeze packages")
  )
#+end_src
...
#+begin_src emacs-lisp
      (use-package evil-nerd-commenter
        ...
        :general
    (global-menu";"   'evilnc-comment-or-uncomment-lines)
    )
#+end_src
...
**** blacken
#+begin_src emacs-lisp
  (use-package blacken :defer t :hook (python-mode . blacken-mode)
